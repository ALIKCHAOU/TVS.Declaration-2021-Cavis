...
{
    public partial class FrmF6001 : Form
    {
        private LiasseController _controller;
        public FrmF6001(LiasseController controller)
        {
            InitializeComponent();
            ...
            foreach (var item in dataLayoutControl1.Items)
            {
                if (item is LayoutControlItem && (item as LayoutControlItem).Control is TextEdit)
                {
                    ...
                    if ("ActeDeDepotComboBoxEdit" == txt.Name) continue;
            ...
            this.f6001BindingSource.DataSource = controller.CurrentF6001();
            saveFileDialog1.FileName = controller.GetXmlFileName(this.f6001BindingSource.Current);
        ...
        private void BtExporter_Click(object sender, EventArgs e)
        {
            ...
            var f6001 = this.f6001BindingSource.Current as Core.Models.Liass.F6001;
        ...
        private void BtEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            var f6001 = this.f6001BindingSource.Current as Core.Models.Liass.F6001;
            _controller.Save(f6001);
            this.f6001BindingSource.DataSource = _controller.CurrentF6001();
