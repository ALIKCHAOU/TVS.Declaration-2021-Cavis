...
{
    [ExportCommandLiasse(Caption = "F6001", LevelNo = 20)]
    public class CommandeF6001 : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as Forms.XtraFrmF6001;
                if (frm == null)
                    continue;
            ...
            var form = ConfigProgram.Kernel.Get<Forms.XtraFrmF6001>();
