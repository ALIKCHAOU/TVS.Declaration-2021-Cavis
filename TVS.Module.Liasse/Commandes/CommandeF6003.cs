...
{
    [ExportCommandLiasse(Caption = "F6003", LevelNo = 40)]
    public class CommandeF6003 : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as Forms.XtraFrmF6003;
                if (frm == null)
                    continue;
            ...
            var form = ConfigProgram.Kernel.Get<Forms.XtraFrmF6003>();
