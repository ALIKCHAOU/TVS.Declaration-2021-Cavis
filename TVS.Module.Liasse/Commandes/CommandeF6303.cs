...
namespace TVS.Module.Liasse.Commandes
{
    ...
    [ExportCommandLiasse(Caption = "F6303", LevelNo = 80)]
    public class CommandeF6303 : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as Forms.XtraFrmF6303;
                if (frm == null)
                    continue;
            ...
            var form = ConfigProgram.Kernel.Get<Forms.XtraFrmF6303>();
