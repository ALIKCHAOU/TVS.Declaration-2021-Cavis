...
{
    [ExportCommandLiasse(Caption = "F6004 Modele Autorsie", LevelNo = 51)]
    public class CommandeF6004ModeleAutorsie : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as Forms.XtraFrmF6004ModeleAutorsie;
                if (frm == null)
                    continue;
            ...
            var form = ConfigProgram.Kernel.Get<Forms.XtraFrmF6004ModeleAutorsie>();
