...
{
    [ExportCommandLiasse(Caption = "F6004", LevelNo = 50)]
    public class CommandeF6004 : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as Forms.XtraFrmF6004;
                if (frm == null)
                    continue;
            ...
            var form = ConfigProgram.Kernel.Get<Forms.XtraFrmF6004>();
