...
{
    public partial class FrmF6004Mau : Form
    {
        private LiasseController _controller;
        public FrmF6004Mau(LiasseController controller)
        {
            InitializeComponent();
            ...
            this.F6004BindingSource.DataSource = controller.CurrentF6004ModeleAutorsie();
