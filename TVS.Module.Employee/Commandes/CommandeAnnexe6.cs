...
{
    [ExportDecEmp(Caption = "Annexe 6", LevelNo = 60)]
    public class CommandeAnnexeSix : ICommand
    {
        public void Execute(CommandContext context)
        {
            ...
            {
                var frm = mdiChild as FrmAnnexe<LigneAnnexeSix, PiedAnnexeSix>;
                if (frm == null)
                    continue;
                frm.Activate();
                return;
            ...
            var annexeImportRepository = new LigneAnnexe6ImportRepository();
            ...
            var controller = new DeclarationEmployeurController<LigneAnnexeSix, PiedAnnexeSix>(annexeSixservice);
            var form = new FrmAnnexe<LigneAnnexeSix, PiedAnnexeSix>(controller, context.Societe, context.Exercice);
