...
{
    class T2016Annexe1Config : EntityTypeConfiguration<T2016Annexe1>
    {
        public T2016Annexe1Config()
        {
            HasRequired(x => x.Societe)
                .WithMany(x => x.T2016Annexe1)
            ...
            Property(x => x.E21).HasPrecision(18, 3);
            Property(x => x.E22).HasPrecision(18, 3);
            Property(x => x.E23).HasPrecision(18, 3);
            Property(x => x.RetenueUnPrct).HasPrecision(18, 3);
            Property(x => x.ContributionConjoncturelle).HasPrecision(18, 3);
            Property(x => x.SalaireNonImposable).HasPrecision(18, 3);
            Property(x => x.ContributionSocialeSolidarite).HasPrecision(18, 3);
            Property(x => x.IntereDetectible).HasPrecision(18, 3);
        }
    }
}